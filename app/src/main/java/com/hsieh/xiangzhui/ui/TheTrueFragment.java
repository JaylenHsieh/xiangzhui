 ...
 */
public class TheTrueFragment extends Fragment {

    private List<Classification> mChinaDreamList = new ArrayList<>();

    public TheTrueFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_the_true, container, false);
        initList();
        RecyclerView theTrueList = view.findViewById(R.id.theTrueList);
        StaggeredGridLayoutManager layoutManager = new StaggeredGridLayoutManager(2,StaggeredGridLayoutManager.VERTICAL);
        ClassificationAdapter adapter = new ClassificationAdapter(mChinaDreamList);
        theTrueList.setLayoutManager(layoutManager);
        theTrueList.setAdapter(adapter);
        return view;
    }
